...
if "%KISAK_VR_COMPATIBILITY_EXIT%"=="2" (
  echo ERROR: The compatibility preflight found a launch blocker.
...
if not "%KISAK_VR_COMPATIBILITY_EXIT%"=="0" (
  echo ERROR: The compatibility report could not be written.
  echo   "%KISAK_VR_COMPATIBILITY_REPORT_PATH%"
  pause
  exit /b 1
)
...
>"%KISAK_VR_SETTINGS_RECEIPT_PATH%" echo KisakCOD VR effective settings receipt
