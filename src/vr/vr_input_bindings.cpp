...
constexpr std::array<ActionDefinition, kActionCount> kActions = {{
    ...
    {Action::GrenadeLauncher, "KISAK_VR_BIND_GRENADE_LAUNCHER", "KISAK_VR_BIND_GRENADE_LAUNCHER_ALT", "grenade_launcher", "Grenade launcher (slot 5)", "Shortcut for COD4 weapon slot 5. Multiple inputs in one slot form a chord and must be held together.", ValueType::Boolean, "right.thumbrest_touch+left.primary_axis.up", "unbound", true},
