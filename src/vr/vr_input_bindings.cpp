...
constexpr std::array<ActionDefinition, kActionCount> kActions = {{
    ...
    {Action::NightVision, "KISAK_VR_BIND_NIGHT_VISION", "KISAK_VR_BIND_NIGHT_VISION_ALT", "night_vision", "Night vision", "Toggle night vision. Multiple inputs in one slot form a chord and must be held together.", ValueType::Boolean, "left.thumbrest_touch+right.primary_axis.down", "unbound", true},
    {Action::Airstrike, "KISAK_VR_BIND_AIRSTRIKE", "KISAK_VR_BIND_AIRSTRIKE_ALT", "airstrike", "Airstrike / mission slot 6", "Shortcut for COD4 mission slot 6. Multiple inputs in one slot form a chord and must be held together.", ValueType::Boolean, "left.thumbrest_touch+right.primary_axis.left", "unbound", true},
    {Action::C4, "KISAK_VR_BIND_C4", "KISAK_VR_BIND_C4_ALT", "c4", "C4 / mission slot 7", "Shortcut for COD4 mission slot 7 and its detonator. Multiple inputs in one slot form a chord and must be held together.", ValueType::Boolean, "left.thumbrest_touch+right.primary_axis.right", "unbound", true},
